  ...
  <div class="login">
    <div class="row">
      <div class="col">
        ...
        <form class="form-signin" @submit.prevent="login" v-if="!isSignUp" id="login-form">
          <img class="mb-4" src="../assets/userIcon.png" alt width="90" height="90">
          ...
          >
          <p class="text-muted">
            <a href="javascript:;;"  style="color:#67696E">Forget password ?</a>
          </p>
          <button class="btn btn-lg btn-primary btn-block" type="submit" id="btn-Login">
        ...
        <p class="mt-3 text-muted">
          ...
          <span v-if="!isSignUp">
            New to Happy-Muebles?
            <a href="javascript:;;" style="color:#789022" @click="toggleForm">Create an Account</a>
          </span>
        </p>
      </div>
    </div>
