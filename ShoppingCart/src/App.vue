<template>
  <div id="app" class="container">
          ...
          <ul class="navbar-nav ml-auto">
            <li class="nav-item">
              <router-link to="/cart" class="nav-link">
                <img src="./assets/HeartIcon.png" width="25" height="25">
                <i class="mr-1">
                  <span class="ml-1">Cupones: {{this.cartProducts.length}}</span>
                </i>
              </router-link>
            </li>
            <li class="nav-item">
              <router-link to="/cart" class="nav-link">
                <img src="./assets/carIcon.png" width="25" height="25">
                <i class="mr-1">
            ...
            <li class="nav-item" v-if="!isLogged()">
              <router-link to="/login" class="nav-link">
               <img src="./assets/userIcon.png" width="25" height="25">
                <i class="mr-1">
    ...
    <footer class="container-fluid footer text-left mt-3">
      <p class="mr-auto">
        Bases de datos II:
        <strong>Tecnológico de Costa Rica</strong>
      </p>
